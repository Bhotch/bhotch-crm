...
// Reusable Form Components - All now include proper id and name attributes
...
const FormField = ({ label, children, fullWidth = false, htmlFor }) => (
    ...
    const handleSubmit = useCallback(async (e) => {
        ...
        if (dataToSubmit.address && (!dataToSubmit.latitude || !dataToSubmit.longitude)) {
            try {
                ...
                console.warn('Geocoding failed during submission:', error);
            }
        }
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <FormSection title="Lead Details">
                            <FormField label="Lead Source" htmlFor="leadSource">
                                <SelectInput
                                    name="leadSource"
                                    value={formData.leadSource || 'Door Knock'}
                                    onChange={handleChange}
                                >
                            ...
                            <FormField label="Disposition" htmlFor="disposition">
                                <SelectInput
                                    name="disposition"
                        ...
                        <FormSection title="Job & Quote Details">
                            ...
                            <FormField label="Roof Type" htmlFor="roofType">
                                <SelectInput
                                    name="roofType"
                                    value={formData.roofType || 'Asphalt Shingle'}
                                    onChange={handleChange}
                                >
                            ...
                            <FormField label="Quote Amount" htmlFor="dabellaQuote">
                                <TextInput
                                    name="dabellaQuote"
                        ...
                        <FormSection title="Notes">
                            <FormField label="Notes" htmlFor="notes" fullWidth>
                                <TextareaInput
                                    name="notes"
